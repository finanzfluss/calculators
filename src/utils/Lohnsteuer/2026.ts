 ...
 */
Object.defineProperty(Lohnsteuer2026, 'TAB1', {
  value: [
    BigDecimal.ZERO(),
 ...
 */
Object.defineProperty(Lohnsteuer2026, 'TAB2', {
  value: [
    BigDecimal.ZERO(),
 ...
 */
Object.defineProperty(Lohnsteuer2026, 'TAB4', {
  value: [
    BigDecimal.ZERO(),
    BigDecimal.valueOf(0.4),
    BigDecimal.valueOf(0.384),
 ...
 */
Object.defineProperty(Lohnsteuer2026, 'TAB5', {
  value: [
    BigDecimal.ZERO(),
...
Object.defineProperty(Lohnsteuer2026, 'ZAHL12', {
  value: BigDecimal.valueOf(12),
})
Object.defineProperty(Lohnsteuer2026, 'ZAHL100', {
  value: BigDecimal.valueOf(100),
})
Object.defineProperty(Lohnsteuer2026, 'ZAHL360', {
  value: BigDecimal.valueOf(360),
})
Object.defineProperty(Lohnsteuer2026, 'ZAHL500', {
  value: BigDecimal.valueOf(500),
})
Object.defineProperty(Lohnsteuer2026, 'ZAHL700', {
  value: BigDecimal.valueOf(700),
})
Object.defineProperty(Lohnsteuer2026, 'ZAHL1000', {
  value: BigDecimal.valueOf(1000),
})
Object.defineProperty(Lohnsteuer2026, 'ZAHL10000', {
...
Lohnsteuer2026.prototype.MPARA = function () {
  ...
  this.KVSATZAN = this.KVZ.divide(Lohnsteuer2026.ZAHL2)
    .divide(Lohnsteuer2026.ZAHL100)
...
Lohnsteuer2026.prototype.MRE4JL = function () {
  if (this.LZZ == 1) {
    ...
    if (this.LZZ == 2) {
      this.ZRE4J = this.RE4.multiply(Lohnsteuer2026.ZAHL12).divide(
        Lohnsteuer2026.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2026.ZAHL12).divide(
        Lohnsteuer2026.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2026.ZAHL12).divide(
        Lohnsteuer2026.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2026.ZAHL12).divide(
        Lohnsteuer2026.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      ...
      if (this.LZZ == 3) {
        this.ZRE4J = this.RE4.multiply(Lohnsteuer2026.ZAHL360).divide(
          Lohnsteuer2026.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2026.ZAHL360).divide(
          Lohnsteuer2026.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2026.ZAHL360).divide(
          Lohnsteuer2026.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2026.ZAHL360).divide(
          Lohnsteuer2026.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
...
Lohnsteuer2026.prototype.MRE4 = function () {
  if (this.ZVBEZJ.compareTo(BigDecimal.ZERO()) == 0) {
    ...
    if (this.LZZ == 1) {
      ...
      this.VBEZB = this.VBEZM.multiply(Lohnsteuer2026.ZAHL12)
        .add(this.VBEZS)
        .setScale(2, BigDecimal.ROUND_DOWN)
      this.HFVB = Lohnsteuer2026.TAB2[this.J]
      this.FVBZ = Lohnsteuer2026.TAB3[this.J]
    }
    this.FVB = this.VBEZB.multiply(Lohnsteuer2026.TAB1[this.J])
      .divide(Lohnsteuer2026.ZAHL100)
    ...
    this.FVBSO = this.FVB.add(
      this.VBEZBSO.multiply(Lohnsteuer2026.TAB1[this.J]).divide(
        Lohnsteuer2026.ZAHL100,
      ),
    ).setScale(2, BigDecimal.ROUND_UP)
    ...
    this.FVBZSO = this.FVBZ.add(
      this.VBEZBSO.divide(Lohnsteuer2026.ZAHL100),
    ).setScale(0, BigDecimal.ROUND_UP)
    ...
    this.HFVBZ = this.VBEZB.divide(Lohnsteuer2026.ZAHL100)
      .subtract(this.FVB)
      .setScale(2, BigDecimal.ROUND_DOWN)
...
Lohnsteuer2026.prototype.MRE4ALTE = function () {
  if (this.ALTER1 == 0) {
    ...
    this.ALTE = this.BMG.multiply(Lohnsteuer2026.TAB4[this.K]).setScale(
      0,
      BigDecimal.ROUND_UP,
    )
...
Lohnsteuer2026.prototype.MBERECH = function () {
  ...
  this.VFRB = this.ANP.add(this.FVB.add(this.FVBZ))
    .multiply(Lohnsteuer2026.ZAHL100)
...
Lohnsteuer2026.prototype.MZTABFB = function () {
  ...
  if (this.STKL == 1) {
    ...
    this.KFB = this.ZKF.multiply(BigDecimal.valueOf(9756)).setScale(
      0,
      BigDecimal.ROUND_DOWN,
    )
  } else {
    if (this.STKL == 2) {
      ...
      if (this.STKL == 3) {
        ...
        if (this.STKL == 4) {
          this.SAP = BigDecimal.valueOf(36)
          this.KFB = this.ZKF.multiply(BigDecimal.valueOf(4878)).setScale(
            0,
            BigDecimal.ROUND_DOWN,
          )
        } else {
...
Lohnsteuer2026.prototype.UPEVP = function () {
  if (this.KRV == 1) {
    ...
    this.VSPR = this.ZRE4VPR.multiply(this.RVSATZAN).setScale(
      2,
      BigDecimal.ROUND_DOWN,
    )
  }
...
Lohnsteuer2026.prototype.MVSPKVPV = function () {
  ...
  if (this.PKV > 0) {
    if (this.STKL == 6) {
      ...
      this.PKPVAGZJ = this.PKPVAGZ.multiply(Lohnsteuer2026.ZAHL12)
        .divide(Lohnsteuer2026.ZAHL100)
        .setScale(2, BigDecimal.ROUND_DOWN)
      this.VSPKVPV = this.PKPV.multiply(Lohnsteuer2026.ZAHL12)
        .divide(Lohnsteuer2026.ZAHL100)
        .setScale(2, BigDecimal.ROUND_DOWN)
    ...
    this.VSPKVPV = this.ZRE4VPR.multiply(
...
Lohnsteuer2026.prototype.MVSPHB = function () {
  ...
  this.VSPALV = this.AVSATZAN.multiply(this.ZRE4VPR).setScale(
    2,
    BigDecimal.ROUND_DOWN,
  )
...
Lohnsteuer2026.prototype.MSOLZ = function () {
  ...
  if (this.JBMG.compareTo(this.SOLZFREI) == 1) {
    ...
    this.JW = this.SOLZJ.multiply(Lohnsteuer2026.ZAHL100).setScale(
      0,
      BigDecimal.ROUND_DOWN,
    )
    this.UPANTEIL()
  ...
  if (this.LZZ == 1) {
    ...
    if (this.LZZ == 2) {
      this.ANTEIL1 = this.JW.divide(
        Lohnsteuer2026.ZAHL12,
        0,
        BigDecimal.ROUND_DOWN,
      )
    } else {
      if (this.LZZ == 3) {
        this.ANTEIL1 = this.JW.multiply(Lohnsteuer2026.ZAHL7).divide(
          Lohnsteuer2026.ZAHL360,
          0,
          BigDecimal.ROUND_DOWN,
        )
      } else {
...
Lohnsteuer2026.prototype.MSONST = function () {
  ...
  if (
    ...
    this.STS = this.LSTSO.subtract(this.LSTOSO)
      ...
      .divide(Lohnsteuer2026.ZAHL100, 0, BigDecimal.ROUND_DOWN)
      .multiply(Lohnsteuer2026.ZAHL100)
    this.STSMIN()
  }
}
  ...
  if (this.STS.compareTo(BigDecimal.ZERO()) == -1) {
    ...
    if (this.MBV.compareTo(BigDecimal.ZERO()) == 0) {
      ...
      this.SOLZLZZ = this.SOLZLZZ.add(
        this.STS.multiply(
          BigDecimal.valueOf(5.5).divide(Lohnsteuer2026.ZAHL100),
        ),
      ).setScale(0, BigDecimal.ROUND_DOWN)
...
Lohnsteuer2026.prototype.MOSONST = function () {
  this.ZRE4J = this.JRE4.divide(Lohnsteuer2026.ZAHL100).setScale(
    2,
    BigDecimal.ROUND_DOWN,
  )
  this.ZVBEZJ = this.JVBEZ.divide(Lohnsteuer2026.ZAHL100).setScale(
    2,
    BigDecimal.ROUND_DOWN,
  )
  ...
  this.ZRE4VP = this.ZRE4VP.subtract(
    this.JRE4ENT.divide(Lohnsteuer2026.ZAHL100),
  )
  this.MZTABFB()
...
Lohnsteuer2026.prototype.MRE4SONST = function () {
  ...
  this.FVB = this.FVBSO
  this.MRE4ABZ()
  this.ZRE4VP = this.ZRE4VP.add(this.MBV.divide(Lohnsteuer2026.ZAHL100))
    .subtract(this.JRE4ENT.divide(Lohnsteuer2026.ZAHL100))
    .subtract(this.SONSTENT.divide(Lohnsteuer2026.ZAHL100))
  ...
  if (this.X.compareTo(this.GFB.add(Lohnsteuer2026.ZAHL1)) == -1) {
    ...
    if (this.X.compareTo(BigDecimal.valueOf(17800)) == -1) {
      ...
      if (this.X.compareTo(BigDecimal.valueOf(69879)) == -1) {
        this.Y = this.X.subtract(BigDecimal.valueOf(17799)).divide(
          Lohnsteuer2026.ZAHL10000,
          6,
          BigDecimal.ROUND_DOWN,
        )
        ...
        this.ST = this.RW.add(BigDecimal.valueOf(1034.87)).setScale(
          0,
          BigDecimal.ROUND_DOWN,
        )
      } else {
        if (this.X.compareTo(BigDecimal.valueOf(277826)) == -1) {
          this.ST = this.X.multiply(BigDecimal.valueOf(0.42))
            .subtract(BigDecimal.valueOf(11135.63))
            .setScale(0, BigDecimal.ROUND_DOWN)
        } else {
          this.ST = this.X.multiply(BigDecimal.valueOf(0.45))
            .subtract(BigDecimal.valueOf(19470.38))
            .setScale(0, BigDecimal.ROUND_DOWN)
        }
      }
    }
